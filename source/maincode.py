...
# data={'Sılver':si,'ETH':eth,'Aselsan':asl,'NetFlix':nf}
# data={'Silver':si,'Aselsan':asl,'NetFlix':nflx, 'BTC':bd}
# data={'Gold':gd, 'Aselsan': asl, 'Silver':si}
data={'Aselsan': aselsan, 'NetFlix': netflix, 'Silver': silver, 'Gold':gold}
# %%%%%%%%%%%%%
...
if True:
    ...
    for key in data.keys():
        ...
        X,y = data[key].prepareTimeSeriesData(method='regression',time=30)
